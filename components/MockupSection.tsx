        ...
        <div className="bg-brand-bg-light rounded-2xl shadow-2xl p-4 lg:p-8 border border-white/10">
          ...
          <div className="flex flex-col md:flex-row bg-brand-bg-dark rounded-b-lg min-h-[400px]">
            ...
            <div className="w-full md:w-1/3 lg:w-1/4 border-r border-white/10 p-4 space-y-2">
                <div className="bg-brand-primary/10 p-3 rounded-lg border-l-4 border-brand-primary">
                    <p className="font-bold text-sm text-brand-text-light">{mockup.sidebar.item1.title}</p>
                    <p className="text-xs text-brand-text-dark truncate">{mockup.sidebar.item1.preview}</p>
                </div>
                <div className="p-3 rounded-lg hover:bg-white/5 cursor-pointer">
                    <p className="font-bold text-sm text-brand-text-light">{mockup.sidebar.item2.title}</p>
                    <p className="text-xs text-brand-text-dark truncate">{mockup.sidebar.item2.preview}</p>
                </div>
                <div className="p-3 rounded-lg hover:bg-white/5 cursor-pointer">
                    <p className="font-bold text-sm text-brand-text-light">{mockup.sidebar.item3.title}</p>
                    <p className="text-xs text-brand-text-dark truncate">{mockup.sidebar.item3.preview}</p>
                </div>
            </div>
            {/* Main Content */}
            <div className="w-full md:w-2/3 lg:w-3/4 p-6">
                <h3 className="text-2xl font-bold text-brand-text-light mb-4">{mockup.main.title}</h3>
